...
const useStyle = makeStyles({
    ...
    image: {
        backgroundImage: `url(${'https://th.bing.com/th/id/OIP.jHyfEsdw_nLbBtryhddOIgHaHa?w=164&h=180&c=7&r=0&o=5&dpr=1.25&pid=1.7'})`,
        background: '#25395C',
                ...
                <Box style={{display: 'flex'}}>
                    ...
                    </Box>
                    {
                        ...
                        <Box className={classes.login}>
                            ...
                            <Typography className={classes.text}>By continuing, you agree to yc-mart 's Terms of Use and Privacy Policy.</Typography>
                            ...
                            <Typography className={classes.createText} onClick={() => toggleSignup()}>New to YC-Mart? Create an account</Typography>
                        </Box> : 
                        <Box className={classes.login}>
